...
import main.java.ips.DHoffkinInput;
import main.java.ips.ExtendedHofkinModel;
import main.java.ips.MHDynModel;
import main.java.ips.MHFlightParser;
import main.java.ips.MHInput;
...
public class TestDHoffkinRun {
	...
	public void testRunDHoffkin() throws IOException, GRBException {
		...
		File btsFile = BTSParser.getBTSFileFromDirectory(TestBTSParser.btsDir, 2017, 7);
